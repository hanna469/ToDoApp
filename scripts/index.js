...
confirmBtn.addEventListener('click',function(){
    if(writeContents.value == ''){
        ...
        errP.innerHTML = '<em>할일을 입력하세요.</em>';
        errP.querySelector('em').style.color = '#f00';
    ...
    if(writeContents.value != ''){//textarea의 값이 빈 값이 아닌 경우 참
        ...
        dateA.classList.add('date'); //기존css의 디자인명통일을 위해서 같은 이름 등록
        ...
        dateA.href = '#'; //a 태그 생성 시 속성없이 기본생성<a> -> href 속성 추가대입
        ...
        allCon.appendChild(li); //allCon > li(순서3) > dataA(순서1) + a(순서2) (li의 자식을 먼저 만들어놓고 마지막으로 li를 allCon의 자식으로 삽입)
